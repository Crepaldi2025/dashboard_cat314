...
def renderizar_sidebar(dados_geo, mapa_nomes_uf):
    with st.sidebar:
        ...
        if opcao == "Skew-T":
            ...
            st.info("Obtém perfil vertical da atmosfera (semelhante a radiossonda) usando dados do modelo ERA5. Inclui perfil de temperatura do ar, temperatura do ponto de orvalho, trajetória da parcela, informações dos ventos, além de alguns índices termodinâmicos.")
