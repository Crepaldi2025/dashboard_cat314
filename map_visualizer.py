# ==================================================================================
# map_visualizer.py — Versão otimizada (Clima-Cast-Crepaldi)
# ==================================================================================
# Melhorias:
#   ✅ Cache de mapas e colorbars (uso de @st.cache_resource / @st.cache_data)
#   ✅ Lazy loading de mapas interativos (folium/geemap)
#   ✅ Redução do tempo de carregamento inicial no Streamlit Cloud
# ==================================================================================
